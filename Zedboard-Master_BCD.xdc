...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {dec[8]}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {dec[9]}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {seven_seg[5]}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {seven_seg[4]}];  # "JA4"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {seven_seg[3]}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {seven_seg[2]}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {seven_seg[1]}];  # "JB3"
#set_property PACKAGE_PIN W8 [get_ports {seven_seg[0]}];  # "JB4"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {dec[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {dec[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {dec[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {dec[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {dec[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {dec[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {dec[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {dec[7]}];  # "LD7"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {bcd[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {bcd[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {bcd[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {bcd[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {SW4}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {SW5}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {Preset}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {reset_n}];  # "SW7"
