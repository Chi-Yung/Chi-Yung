...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {seg7[7]}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {seg7[6]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {seg7[5]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {seg7[4]}];  # "JA4"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {seg7[3]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {seg7[2]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {seg7[1]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {seg7[0]}];  # "JB4"
...
set_property PACKAGE_PIN AA4 [get_ports {rx_pin_in}];  # "JC2_N"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN T22 [get_ports {seg7[0]}];  # "LD0"
#set_property PACKAGE_PIN T21 [get_ports {seg7[7]}];  # "LD1"
#set_property PACKAGE_PIN U22 [get_ports {seg7[6]}];  # "LD2"
#set_property PACKAGE_PIN U21 [get_ports {seg7[5]}];  # "LD3"
#set_property PACKAGE_PIN V22 [get_ports {seg7[4]}];  # "LD4"
#set_property PACKAGE_PIN W22 [get_ports {seg7[3]}];  # "LD5"
#set_property PACKAGE_PIN U19 [get_ports {seg7[2]}];  # "LD6"
#set_property PACKAGE_PIN U14 [get_ports {seg7[1]}];  # "LD7"
